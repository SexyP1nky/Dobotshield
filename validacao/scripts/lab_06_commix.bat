...
call "%SCRIPT_DIR%\lab_06_commix_one.bat" dvwa no_waf      "http://!IP_DVWA!:80/vulnerabilities/exec/"            lab_dvwa      ""                "!DVWA_COOKIE!" "ip=127.0.0.1&Submit=Submit"
if errorlevel 1 set "FAIL=1"
call "%SCRIPT_DIR%\lab_06_commix_one.bat" dvwa modsecurity "https://!IP_MODSEC_DVWA!:8443/vulnerabilities/exec/"  lab_dvwa      lab_modsec_dvwa   "!DVWA_COOKIE!" "ip=127.0.0.1&Submit=Submit"
if errorlevel 1 set "FAIL=1"
call "%SCRIPT_DIR%\lab_06_commix_one.bat" dvwa dobotshield "https://!IP_DOBOT_DVWA!:443/vulnerabilities/exec/"    lab_dvwa      lab_dobot_dvwa    "!DVWA_COOKIE!" "ip=127.0.0.1&Submit=Submit"
if errorlevel 1 set "FAIL=1"
call "%SCRIPT_DIR%\lab_06_commix_one.bat" dvwa coraza      "https://!IP_CORAZA_DVWA!:443/vulnerabilities/exec/"   lab_dvwa      lab_coraza_dvwa   "!DVWA_COOKIE!" "ip=127.0.0.1&Submit=Submit"
if errorlevel 1 set "FAIL=1"

REM --- XVWA: Command Injection (GET /xvwa/vulnerabilities/cmdi/, parametro target; sem cookie) ---
call "%SCRIPT_DIR%\lab_06_commix_one.bat" xvwa no_waf      "http://!IP_XVWA!:80/xvwa/vulnerabilities/cmdi/?target=127.0.0.1"            lab_xvwa      ""                "" ""
if errorlevel 1 set "FAIL=1"
call "%SCRIPT_DIR%\lab_06_commix_one.bat" xvwa modsecurity "https://!IP_MODSEC_XVWA!:8443/xvwa/vulnerabilities/cmdi/?target=127.0.0.1"  lab_xvwa      lab_modsec_xvwa   "" ""
if errorlevel 1 set "FAIL=1"
call "%SCRIPT_DIR%\lab_06_commix_one.bat" xvwa dobotshield "https://!IP_DOBOT_XVWA!:443/xvwa/vulnerabilities/cmdi/?target=127.0.0.1"    lab_xvwa      lab_dobot_xvwa    "" ""
if errorlevel 1 set "FAIL=1"
call "%SCRIPT_DIR%\lab_06_commix_one.bat" xvwa coraza      "https://!IP_CORAZA_XVWA!:443/xvwa/vulnerabilities/cmdi/?target=127.0.0.1"   lab_xvwa      lab_coraza_xvwa   "" ""
if errorlevel 1 set "FAIL=1"
