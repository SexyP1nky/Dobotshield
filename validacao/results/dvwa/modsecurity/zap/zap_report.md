...
| Low | Exceeded High | https://172.18.0.5:8443 | Percentage of responses with status code 4xx | 52 % |
...
| Info | Informational | https://172.18.0.5:8443 | Percentage of responses with status code 2xx | 35 % |
...
| Info | Informational | https://172.18.0.5:8443 | Percentage of endpoints with method GET | 87 % |
| Info | Informational | https://172.18.0.5:8443 | Percentage of endpoints with method POST | 12 % |
| Info | Informational | https://172.18.0.5:8443 | Count of total endpoints | 55    |
...
* URL: https://172.18.0.5:8443/vulnerabilities/xss_s/
  ...
  * Method: `POST`
  * Parameter: `btnSign`
  * Attack: `Sign Guestbook AND 1=1`
  * Evidence: ``
  * Other Info: `The page results were successfully manipulated using the boolean conditions [Sign Guestbook AND 1=1] and [Sign Guestbook AND 1=2]
...
* URL: https://172.18.0.5:8443/vulnerabilities/captcha/
  ...
  * Evidence: ``
  * Other Info: ``
* URL: https://172.18.0.5:8443/vulnerabilities/sqli_blind/
  * Node Name: `https://172.18.0.5:8443/vulnerabilities/sqli_blind/`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
...
- nginx
`
* URL: https://172.18.0.5:8443/vulnerabilities/xss_d/%3Fdefault
  * Node Name: `https://172.18.0.5:8443/vulnerabilities/xss_d/ (default)`
  * Method: `GET`
  * Parameter: ``
  * Attack: `TRACE, OPTIONS methods with 'Max-Forwards' header. TRACK method.`
  * Evidence: ``
...
- nginx
`
* URL: https://172.18.0.5:8443/vulnerabilities/xss_r/%3Fname=ZAP
  * Node Name: `https://172.18.0.5:8443/vulnerabilities/xss_r/ (name)`
  * Method: `GET`
  * Parameter: ``
  * Attack: `TRACE, OPTIONS methods with 'Max-Forwards' header. TRACK method.`
  * Evidence: ``
...
* URL: https://172.18.0.5:8443/about.php
  * Node Name: `https://172.18.0.5:8443/about.php/6hkit/szmfq`
  * Method: `GET`
  * Parameter: ``
  * Attack: `https://172.18.0.5:8443/about.php/6hkit/szmfq`
...
* URL: https://172.18.0.5:8443/instructions.php
  * Node Name: `https://172.18.0.5:8443/instructions.php/6hkit/szmfq`
  * Method: `GET`
  * Parameter: ``
  * Attack: `https://172.18.0.5:8443/instructions.php/6hkit/szmfq`
  * Evidence: `<link rel="stylesheet" type="text/css" href="dvwa/css/main.css">`
  * Other Info: `No <base> tag was specified in the HTML <head> tag to define the location for relative URLs.
A Content Type of "text/html;charset=utf-8" was specified. If the web browser is employing strict parsing rules, this will prevent cross-content attacks from succeeding. Quirks Mode in the web browser would disable strict parsing.
Quirks Mode is implicitly enabled via the use of an old DOCTYPE with PUBLIC id "-//W3C//DTD XHTML 1.0 Strict//EN", allowing the specified Content Type to be bypassed in some web browsers.`
* URL: https://172.18.0.5:8443/instructions.php%3Fdoc=PHPIDS-license
  * Node Name: `https://172.18.0.5:8443/instructions.php/6hkit/szmfq (doc)`
  * Method: `GET`
  * Parameter: ``
  * Attack: `https://172.18.0.5:8443/instructions.php/6hkit/szmfq?doc=PHPIDS-license`
  * Evidence: `<link rel="stylesheet" type="text/css" href="dvwa/css/main.css">`
  * Other Info: `No <base> tag was specified in the HTML <head> tag to define the location for relative URLs.
A Content Type of "text/html;charset=utf-8" was specified. If the web browser is employing strict parsing rules, this will prevent cross-content attacks from succeeding. Quirks Mode in the web browser would disable strict parsing.
Quirks Mode is implicitly enabled via the use of an old DOCTYPE with PUBLIC id "-//W3C//DTD XHTML 1.0 Strict//EN", allowing the specified Content Type to be bypassed in some web browsers.`
* URL: https://172.18.0.5:8443/phpinfo.php
  * Node Name: `https://172.18.0.5:8443/phpinfo.php/6hkit/szmfq`
  * Method: `GET`
  * Parameter: ``
  * Attack: `https://172.18.0.5:8443/phpinfo.php/6hkit/szmfq`
...
* URL: https://172.18.0.5:8443/DTD/xhtml1-transitional.dtd
  * Node Name: `https://172.18.0.5:8443/DTD/xhtml1-transitional.dtd`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
...
* URL: https://172.18.0.5:8443/phpinfo.php
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `172.18.0.4:80`
  * Other Info: `172.18.0.4:80
172.18.0.11
172.18.0.11
172.18.0.4
172.18.0.11
...
* URL: https://172.18.0.5:8443/phpinfo.php
  ...
  * Attack: ``
  * Evidence: `1784328682`
  * Other Info: `1784328682, which evaluates to: 2026-07-17 22:51:22.`
...
login`
* URL: https://172.18.0.5:8443/vulnerabilities/sqli/%3FSubmit=Submit&id=ZAP
  * Node Name: `https://172.18.0.5:8443/vulnerabilities/sqli/ (Submit,id)`
  * Method: `GET`
  * Parameter: `Submit`
  * Attack: ``
...
https://172.18.0.5:8443/vulnerabilities/sqli/?Submit=Submit&id=ZAP
...
https://172.18.0.5:8443/vulnerabilities/captcha/
