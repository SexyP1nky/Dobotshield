...
| Info | Informational | http://172.18.0.3 | Percentage of responses with status code 2xx | 54 % |
| Info | Informational | http://172.18.0.3 | Percentage of responses with status code 3xx | 24 % |
| Info | Exceeded Low | http://172.18.0.3 | Percentage of responses with status code 4xx | 20 % |
| Info | Informational | http://172.18.0.3 | Percentage of endpoints with content type text/html | 100 % |
| Info | Informational | http://172.18.0.3 | Percentage of endpoints with method GET | 100 % |
| Info | Informational | http://172.18.0.3 | Count of total endpoints | 32    |
| Info | Informational | http://172.18.0.3 | Percentage of slow responses | 1 % |
| Info | Informational | https://172.18.0.3 | Percentage of endpoints with method GET | 100 % |
| Info | Informational | https://172.18.0.3 | Count of total endpoints | 1    |
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/reflected_xss/%3Fitem=%253C%252Fdiv%253E%253CscrIpt%253Ealert%25281%2529%253B%253C%252FscRipt%253E%253Cdiv%253E
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/reflected_xss/ (item)`
  * Method: `GET`
  * Parameter: `item`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/fi/%3Ffile=%252Fetc%252Fpasswd
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/fi/ (file)`
  * Method: `GET`
  * Parameter: `file`
  * Attack: `/etc/passwd`
  * Evidence: `root:x:0:0`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/fi/%3Ffile=http%253A%252F%252Fwww.google.com%252F
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/fi/ (file)`
  * Method: `GET`
  * Parameter: `file`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/cmdi/%3Ftarget=127.0.0.1%2526cat+%252Fetc%252Fpasswd%2526
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/cmdi/ (target)`
  * Method: `GET`
  * Parameter: `target`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/fi/%3Ffile=test.php
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/fi/ (file)`
  * Method: `GET`
  * Parameter: `file`
  * Attack: ``
  * Evidence: ``
  * Other Info: `Received out-of-band interaction [GET http://172.18.0.11:37139/bd77f467-8bf6-40f5-957c-e5527b42e909 HTTP/1.0]
Request
GET http://172.18.0.11:37139/bd77f467-8bf6-40f5-957c-e5527b42e909 HTTP/1.0
Host: 172.18.0.11:37139
Connection: close
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/fi/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/fi/`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/idor/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/idor/`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `<form class='form' method='POST' id='formLogin' action='/xvwa/login.php'>`
  * Other Info: `No known Anti-CSRF token [anticsrf, CSRFToken, __RequestVerificationToken, csrfmiddlewaretoken, authenticity_token, OWASP_CSRFTOKEN, anoncsrf, csrf_token, _csrf, _csrfSecret, __csrf_magic, CSRF, _token, _csrf_token, _csrfToken] was found in the following HTML form: [Form 1: "password" "username" ].`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/reflected_xss/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/reflected_xss/`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `<form class='form' method='POST' id='formLogin' action='/xvwa/login.php'>`
  * Other Info: `No known Anti-CSRF token [anticsrf, CSRFToken, __RequestVerificationToken, csrfmiddlewaretoken, authenticity_token, OWASP_CSRFTOKEN, anoncsrf, csrf_token, _csrf, _csrfSecret, __csrf_magic, CSRF, _token, _csrf_token, _csrfToken] was found in the following HTML form: [Form 1: "password" "username" ].`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/sqli_blind/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/sqli_blind/`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `<form class='form' method='POST' id='formLogin' action='/xvwa/login.php'>`
  * Other Info: `No known Anti-CSRF token [anticsrf, CSRFToken, __RequestVerificationToken, csrfmiddlewaretoken, authenticity_token, OWASP_CSRFTOKEN, anoncsrf, csrf_token, _csrf, _csrfSecret, __csrf_magic, CSRF, _token, _csrf_token, _csrfToken] was found in the following HTML form: [Form 1: "password" "username" ].`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/ssti/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/ssti/`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `<form class='form' method='POST' id='formLogin' action='/xvwa/login.php'>`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/cmdi/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/cmdi/`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/sqli_blind/
  ...
  * Evidence: ``
  * Other Info: ``
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/ssrf_xspa/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/ssrf_xspa/`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/xpath/
  * Node Name: `https://172.18.0.3/xvwa/vulnerabilities/xpath/`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
  * Other Info: `Failed to connect.
ZAP attempted to connect via: https://172.18.0.3/xvwa/vulnerabilities/xpath/`
...
* URL: http://172.18.0.3:80/xvwa/instruction.php
  * Node Name: `http://172.18.0.3/xvwa/instruction.php`
  * Method: `GET`
  * Parameter: `x-frame-options`
  * Attack: ``
  * Evidence: ``
  * Other Info: ``
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/dom_xss/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/dom_xss/`
  * Method: `GET`
  * Parameter: `x-frame-options`
  * Attack: ``
  * Evidence: ``
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/cmdi/%3Ftarget=%2500
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/cmdi/ (target)`
  * Method: `GET`
  * Parameter: `target`
  * Attack: ` `
  * Evidence: ` on line <b>`
  * Other Info: ``
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/fi/%3Ffile=
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/fi/ (file)`
  * Method: `GET`
  * Parameter: `file`
  * Attack: ``
...
* URL: http://172.18.0.3:80/xvwa/instruction.php
  * Node Name: `http://172.18.0.3/xvwa/instruction.php/jzbp6/yqdwo`
  * Method: `GET`
  * Parameter: ``
  * Attack: `http://172.18.0.3:80/xvwa/instruction.php/jzbp6/yqdwo`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/reflected_xss/
  ...
  * Evidence: `<script src="https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.js"></script>`
  * Other Info: ``
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/sqli/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/sqli/`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `<script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/sqli_blind/
  ...
  * Other Info: ``
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/xpath/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/xpath/`
  * Method: `GET`
  * Parameter: `Cross-Origin-Embedder-Policy`
  * Attack: ``
  * Evidence: ``
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/fi/
  ...
  * Evidence: ``
  * Other Info: ``
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/php_object_injection/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/php_object_injection/`
  * Method: `GET`
  * Parameter: `Cross-Origin-Opener-Policy`
  * Attack: ``
  * Evidence: ``
...
* URL: http://172.18.0.3/robots.txt
  * Node Name: `http://172.18.0.3/robots.txt`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `Apache/2.4.54`
  * Other Info: `There is a chance that the highlight in the finding is on a value in the headers, versus the actual matched string in the response body.`
* URL: http://172.18.0.3/sitemap.xml
  * Node Name: `http://172.18.0.3/sitemap.xml`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `Apache/2.4.54`
...
* URL: http://172.18.0.3:80/xvwa/
  * Node Name: `http://172.18.0.3/xvwa/`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/cmdi/
  ...
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/cmdi/%3Ftarget=127.0.0.1
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/cmdi/ (target)`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/crypto/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/crypto/`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/fi/%3Ffile=test.php
  ...
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/fileupload/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/fileupload/`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/formula_injection/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/formula_injection/`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/idor/
  ...
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/idor/%3Fitem=1
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/idor/ (item)`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/missfunc/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/missfunc/`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/php_object_injection/
  ...
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/php_object_injection/%3Fr=test
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/php_object_injection/ (r)`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/redirect/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/redirect/`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/redirect/%3Furl=http://example.com
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/redirect/ (url)`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/reflected_xss/
  ...
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/reflected_xss/%3Fitem=test
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/reflected_xss/ (item)`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/sessionflaws/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/sessionflaws/`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
...
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/ssti/
  ...
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/ssti/%3Fname=test
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/ssti/ (name)`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
  * Other Info: `cookie:PHPSESSID`
* URL: http://172.18.0.3:80/xvwa/vulnerabilities/stored_xss/
  * Node Name: `http://172.18.0.3/xvwa/vulnerabilities/stored_xss/`
  * Method: `GET`
  * Parameter: `PHPSESSID`
  * Attack: ``
  * Evidence: `PHPSESSID`
...
http://172.18.0.3:80/xvwa/vulnerabilities/idor/?item=1
